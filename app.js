...
class RadioPlayer {
    constructor() {
        this.audio = new Audio('https://media.radiostreamingjm.com/listen/stereojm/mobile.mp3');
    ...
    async setupMetadataUpdates() {
        const updateMetadata = async () => {
            try {
                const response = await fetch('https://media.radiostreamingjm.com/api/nowplaying/stereojm');
    ...
    async togglePlay() {
        ...
        try {
            if (!this.isPlaying) {
                ...
                this.audio = new Audio(`https://media.radiostreamingjm.com/listen/stereojm/mobile.mp3?t=${Date.now()}`);
                this.audio.crossOrigin = "anonymous";
